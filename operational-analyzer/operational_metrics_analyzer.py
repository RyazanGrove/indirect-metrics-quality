...
dimensions_array = np.zeros((4,11))
...
for service_index, current_service in enumerate(services_metadata["operational"]):
    ...
    if 'Test Pass Rate' in columns_to_analyze:
...
accuracy_df.to_excel('..\\output\\operational_metrics\\operational_metrics_accuracy.xlsx', float_format="%.3f")
print(accuracy_df)